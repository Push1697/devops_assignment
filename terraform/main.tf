...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "devops-assignment-public-${count.index + 1}"
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "devops-assignment-private-${count.index + 1}"
  }
}
...
resource "aws_iam_role" "ec2_role" {
  name = "devops_assignment_ec2_role"
...
resource "aws_iam_instance_profile" "ec2_profile" {
  name = "devops_assignment_ec2_profile"
  role = aws_iam_role.ec2_role.name
}
...
resource "aws_autoscaling_group" "app" {
  ...
  tag {
    key                 = "Name"
    value               = "devops-assignment-instance"
